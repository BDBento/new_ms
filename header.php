                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <div class="barra-governo container ">
                        <div class=" d-flex justify-content-between row">
                            <nav
                                class="nav justify-content-md-start justify-content-center barra-governo-text col-md-6 col-12">
                            ...
                            <nav
                                class="nav justify-content-md-end justify-content-center barra-governo-text barra-governo-text-3 col-md-4 col-12">
    ...
    <div class="container" style="padding: 20px;">
        <div class=" container menu-inicial-direction">
            <div class="menu-principal-cards">
                <div class="menu-principal-cards-identidade">
                    <div class="identicade-secretaria">
                        <?php
                        // Se for FrontPage or Home
                        if (is_home() || is_front_page()) {
                            echo '<p>' . get_bloginfo('name') . '</p>';
                            echo '<p style="font-size:11px">' . get_bloginfo('description') . '</p>';
                        } else {
                            echo '<p>' . get_bloginfo('name') . '</p>';
                            echo '<p style="font-size:11px">' . get_bloginfo('description') . '</p>';
                        }
